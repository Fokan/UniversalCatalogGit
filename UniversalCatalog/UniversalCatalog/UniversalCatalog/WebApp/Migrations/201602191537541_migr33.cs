namespace WebApp.Migrations
{
    ...
    public partial class migr33 : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Images", "ImageType", c => c.String(nullable: false));
            AlterColumn("dbo.Images", "Data", c => c.Binary(nullable: false));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.Images", "Data", c => c.Binary());
